...
- Parent/main SHA: `<run: git rev-parse main>` 8fbdf4dbbf239b3bedd22b918f029f2d73fa1c76
- Working SHA: `<run: git rev-parse HEAD>` 8fbdf4dbbf239b3bedd22b918f029f2d73fa1c76

## Runtime

- Python: `<run: python --version>` Python 3.12.7
